...
class WebService {
  ...
  static const String markNotificationsAsRead = "${apiURL}markNotificationsAsRead";
  static const String fetchUnreadNotificationCount = "${apiURL}fetchUnreadNotificationCount";
  ...
  static const String fetchSavedPosts = "${apiURL}fetchSavedPosts";
  static const String editPost = "${apiURL}editPost";
  static const String repostPost = "${apiURL}repostPost";
  static const String fetchReposts = "${apiURL}fetchReposts";
  ...
  static const String fetchReelCommentReplies = "${apiURL}fetchReelCommentReplies";
  static const String editReelComment = "${apiURL}editReelComment";
  static const String deleteReelComment = "${apiURL}deleteReelComment";
  static const String likeDislikeReelComment = "${apiURL}likeDislikeReelComment";
  ...
  static const String companyLogin = "${apiURL}Company/login";
  static const String companyVerifyEmail = "${apiURL}Company/verifyEmail";
  static const String companyResendVerification = "${apiURL}Company/resendVerification";
  static const String companyEditProfile = "${apiURL}Company/editProfile";
  static const String companyFetchProfile = "${apiURL}Company/fetchProfile";
  static const String companyFetchDashboard = "${apiURL}Company/fetchDashboard";
  static const String companyPublicProfile = "${apiURL}Company/publicProfile";
  static const String companyFollow = "${apiURL}Company/followCompany";
  static const String companyUnfollow = "${apiURL}Company/unfollowCompany";
  static const String companyFetchFollowed = "${apiURL}Company/fetchFollowedCompanies";

  // ─── Job Board: Jobs ───
  static const String fetchJobs = "${apiURL}Job/fetchJobs";
  static const String fetchJobDetail = "${apiURL}Job/fetchJobDetail";
  static const String toggleSaveJob = "${apiURL}Job/toggleSaveJob";
  static const String fetchSavedJobs = "${apiURL}Job/fetchSavedJobs";
  static const String createJob = "${apiURL}Job/createJob";
  static const String editJob = "${apiURL}Job/editJob";
  static const String deleteJob = "${apiURL}Job/deleteJob";
  static const String fetchCompanyJobs = "${apiURL}Job/fetchCompanyJobs";

  // ─── Job Board: Applications ───
  static const String applyToJob = "${apiURL}Application/applyToJob";
  static const String fetchMyApplications = "${apiURL}Application/fetchMyApplications";
  static const String fetchJobApplications = "${apiURL}Application/fetchJobApplications";
  static const String updateApplicationStatus = "${apiURL}Application/updateApplicationStatus";
}
