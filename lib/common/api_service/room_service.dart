...
class RoomService {
  ...
  Future<void> fetchRoomUsersList(num roomId, num start,
      Function(List<RoomMember> users) completion) async {
    var param = {
      Param.roomId: roomId,
      Param.start: start,
  ...
  Future<void> searchUserForInvitation(num roomId, String keyword, int start,
      Function(List<User> users) completion) async {
    var param = {
      Param.roomId: roomId,
  ...
  Future<void> reportRoom(num roomId, String reason, String desc) async {
    var param = {
      Param.roomId: roomId,
      Param.reason: reason,
      Param.desc: desc,
  ...
  Future<void> fetchRoomByInterest(
      int interestId, int start, Function(List<Room> rooms) completion) async {
    var param = {
      Param.userId: SessionManager.shared.getUserID(),
