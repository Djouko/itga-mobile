...
class ChatUserRoom {
  ...
  Map<String, dynamic> toFireStore() {
    return {
      ...
      if (profileType != null) "profile_type": _profileType,
      if (companyId != null) "company_id": _companyId,
  ...
  ChatUserRoom.fromJson(Map<String, dynamic> json) {
    ...
    _profileType = json["profile_type"] ?? json["profileType"];
    _companyId = json["company_id"] ?? json["companyId"];
...
class ChatMessage {
  ...
  num? _senderId;
  num? _senderCompanyId;
  String? _senderProfileType;
  String? _senderName;
  ...
  ChatMessage(
    ...
    _senderProfileType = senderProfileType;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "msgType": _msgType,
      "senderId": _senderId,
      "sender_company_id": _senderCompanyId,
      "sender_profile_type": _senderProfileType,
  ...
  ChatMessage.fromJson(Map<String, dynamic>? json) {
    ...
    _senderCompanyId = json?["sender_company_id"] ?? json?["senderCompanyId"];
    _senderProfileType =
        json?["sender_profile_type"] ?? json?["senderProfileType"];
    _senderName = json?["sender_name"] ?? json?["senderName"];
    _senderUsername = json?["sender_username"] ?? json?["senderUsername"];
    _senderAvatar = json?["sender_avatar"] ?? json?["senderAvatar"];
  ...
  factory ChatMessage.fromFireStore(
    ...
    return ChatMessage(
        ...
        senderCompanyId: data?['sender_company_id'] ?? data?['senderCompanyId'],
        senderProfileType:
  ...
  Map<String, dynamic> toFireStore() {
    return {
      ...
      if (senderCompanyId != null) "sender_company_id": _senderCompanyId,
      if (senderProfileType != null) "sender_profile_type": _senderProfileType,
      if (senderName != null) "sender_name": _senderName,
      if (senderUsername != null) "sender_username": _senderUsername,
      if (senderAvatar != null) "sender_avatar": _senderAvatar,
  ...
  num? get senderCompanyId => _senderCompanyId;

  String? get senderProfileType => _senderProfileType;
  ...
  MessageType get msgType =>
      MessageType.values
          .firstWhereOrNull((element) => element.value == _msgType) ??
      MessageType.text;
...
extension ChatUserExt on User {
  ...
  AudioSpaceUser toAudioSpaceUser(AudioSpaceUserType type) {
    ...
    final isCompanyActor = actingCompanyId != null &&
        id?.toInt() == SessionManager.shared.getUserID();
    ...
    return AudioSpaceUser(
      ...
      id: id?.toInt(),
      username: isCompanyActor ? 'company-$actingCompanyId' : username,
      image: isCompanyActor ? null : profile,
      companyId: actingCompanyId,
      profileType: isCompanyActor ? 'company' : 'user',
      displayName: actorName,
      displayAvatar: isCompanyActor ? null : profile,
      type: type,
      micStatus: AudioSpaceUserType.admin == type
