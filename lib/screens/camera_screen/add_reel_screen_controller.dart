    ...
    SightEngineService.shared.chooseTextModeration(
        ...
        completion: () async {
          ...
          SightEngineService.shared.checkVideoInSightEngine(
              ...
              completion: () async {
                // TikTok/Instagram: compress video + thumbnail before upload
                final compressedVideo = await MediaCompressor.shared.compressVideo(XFile(data.value.videoPath!));
                final compressedThumb = await MediaCompressor.shared.compressThumbnail(XFile(data.value.thumbnailPath!));

                Reel? reel = await ReelService.shared.uploadReel(
                  description: textEditingController.text,
                  content: compressedVideo,
