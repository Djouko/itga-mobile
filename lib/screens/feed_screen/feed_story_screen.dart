                            ...
                            children: [
                              Container(
                                decoration: BoxDecoration(
                                    border: Border.all(
                                      color: storyUser.isAllStoryShown()
  ...
  Widget myCard(FeedStoriesController controller) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Get.bottomSheet(CreateStoryScreen(user: controller.myUser),
      ...
      child: Container(
        ...
        child: Column(
          children: [
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                        border: Border.all(
                          color: isAnyStory
                              ? (controller.myUser.isAllStoryShown()
                                  ? cLightText.withValues(alpha: 0.4)
                                  : cPrimary)
                              : Colors.transparent,
                          width: 2,
            ...
            Text(
              controller.myUser.profileType == 'company'
                  ? controller.myUser.fullName ?? LKeys.story.tr
                  : LKeys.you.tr,
              style: MyTextStyle.gilroyMedium(size: 14),
              overflow: TextOverflow.ellipsis,
            ),
