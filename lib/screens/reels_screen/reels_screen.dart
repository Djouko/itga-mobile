...
class ReelsScreen extends StatefulWidget {
  ...
  final bool Function()? hasNetworkError;
                    ...
                    () => Stack(
                      ...
                      children: [
                        if (controller.reels.isEmpty)
                          if (widget.hasNetworkError?.call() == true)
                            NetworkErrorView(onRetry: () {
                              widget.onRetry?.call();
                            })
                          else if (widget.isLoading.value)
                            ...
                            child: Obx(
                              () => PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final playerEntry = controller.players[index];
                                  return RepaintBoundary(
                                    child: ReelPage(
                                      reelData: reel,
                                      videoPlayerController: playerEntry?.controller,
                                    ),
                                  );
                                },
                              ),
