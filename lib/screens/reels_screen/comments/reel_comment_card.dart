...
class ReelCommentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isMyComment = actingCompanyId != null
        ? comment.companyId == actingCompanyId
        : SessionManager.shared.getUserID() == comment.userId &&
            comment.companyId == null;
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  if (comment.description != null) {
                    Clipboard.setData(
                        ClipboardData(text: comment.description!));
                  }
                },
              ),
              ListTile(
  ...
  Widget view() {
    ...
    final actorName = comment.company?.name ?? comment.user?.fullName ?? '';
    final actorImage = comment.company?.logo ?? comment.user?.profile;
    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          children: [
                            ...
                            if (comment.company != null)
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: cCyan.withValues(alpha: 0.28)),
                                ),
                                child: Text(
                                  'Entreprise',
                            ...
                            Text(
                              comment.createdAt?.timeAgoShort() ?? '',
  ...
  void goToProfile() {
    Get.back();
    final companyId = comment.company?.id ?? comment.companyId;
    if (companyId != null) {
