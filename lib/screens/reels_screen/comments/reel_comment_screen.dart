        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              Expanded(
                child: GetBuilder<ReelCommentController>(
                  init: controller,
                  builder: (_) {
                    return NoDataView(
              ...
              GetBuilder<ReelCommentController>(
                init: controller,
                builder: (_) {
                  ...
                  if (controller.replyingTo != null) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: const Border(left: BorderSide(color: cPrimary, width: 3)),
                      ),
                      child: Row(
                        children: [
                          const Icon(Icons.reply_rounded, color: cPrimary, size: 16),
                          const SizedBox(width: 6),
                          Expanded(
                            child: Text(
