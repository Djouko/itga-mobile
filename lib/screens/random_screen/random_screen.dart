                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        TopBarForOnBoarding(
                          titleEnd: isProfile ? LKeys.found : (controller.isLoading.value ? LKeys.profile : LKeys.noDataFound),
                          desc: '',
                          titleStart: isProfile ? LKeys.profile : (controller.isLoading.value ? LKeys.searching : ''),
                        ),
                      ],
                    ),
                    const Spacer(),
                    ...
                    Container(
                      ...
                      child: isProfile
                          ...
                          : controller.isLoading.value
                              ? Text(LKeys.searchingDesc.tr, textAlign: TextAlign.center, style: MyTextStyle.gilroyLight(color: cDarkText))
                              : CommonButton(text: LKeys.next, onTap: controller.next),
                    ),
                  ],
                ),
