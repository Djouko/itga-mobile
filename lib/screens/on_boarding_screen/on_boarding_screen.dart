              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: MyTextStyle.gilroyLight(size: 22, color: cDarkText),
                  ),
                  const SizedBox(
                    height: 3,
                  ),
                  Text(
                    ...
                    style: MyTextStyle.gilroySemiBold(size: 23, color: cNavy),
                  ),
                ],
              ),
            ),
                ...
                children: List.generate(screens.length, (index) {
                  ...
                  return AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isActive ? cPrimary : cLightText.withValues(alpha: 0.15),
              ...
              child: GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Text(
                      LKeys.skip.tr,
                      style: MyTextStyle.gilroySemiBold(size: 15, color: cLightText.withValues(alpha: 0.6)),
