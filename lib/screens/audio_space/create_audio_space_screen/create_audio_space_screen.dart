                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _VideoConferenceToggle(controller: controller),
                                  const SizedBox(height: 30),
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      var isSelected = (controller.hosts.firstWhereOrNull((element) => user.id?.toInt() == element.id?.toInt()) != null);
                                      return Column(
                                        children: [
                                          Row(
                                            children: [
...
class _VideoConferenceToggle extends StatelessWidget {
  final CreateAudioSpaceController controller;
  const _VideoConferenceToggle({required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          LKeys.roomType.tr.toUpperCase(),
          style: MyTextStyle.gilroyExtraBold(size: 14, color: cDarkText),
        ),
        const SizedBox(height: 10),
        Row(
          children: [
            Expanded(
              child: GestureDetector(
                onTap: () {
                  if (controller.isVideoConference) controller.toggleVideoConference();
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  decoration: ShapeDecoration(
                    color: !controller.isVideoConference ? cPrimary.withValues(alpha: 0.15) : cLightBg,
                    shape: SmoothRectangleBorder(
                      side: BorderSide(
                        color: !controller.isVideoConference ? cPrimary : cLightBg,
                        width: 2,
                      ),
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.mic_rounded, color: !controller.isVideoConference ? cPrimary : cLightText, size: 28),
                      const SizedBox(height: 6),
                      Text(
                        LKeys.audioSpace.tr,
                        style: MyTextStyle.gilroySemiBold(
                          size: 13,
                          color: !controller.isVideoConference ? cPrimary : cLightText,
                        ),
                      ),
                    ],
                  ),
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.videocam_rounded, color: controller.isVideoConference ? cPrimary : cLightText, size: 28),
                      const SizedBox(height: 6),
                      Text(
                        LKeys.videoConference.tr,
                        style: MyTextStyle.gilroySemiBold(
                          size: 13,
                          color: controller.isVideoConference ? cPrimary : cLightText,
                        ),
