...
class SearchScreen extends StatelessWidget {
                ...
                Container(
                  decoration: ShapeDecoration(
                      shape: CircleBorder(
                          side: BorderSide(
                              width: 2,
                              color: cLightText.withValues(alpha: 0.1)))),
  ...
  Widget reelsView(SearchScreenController controller) {
    return RefreshIndicator(
      ...
      onRefresh: () => controller.searchReel(shouldErase: true),
  ...
  Widget postsView(SearchScreenController controller) {
    return RefreshIndicator(
      color: refreshIndicatorColor,
      backgroundColor: refreshIndicatorBgColor,
      onRefresh: () => controller.searchPost(shouldErase: true),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return RoomInterestTag(
                      ...
                      onTap: () {
                        Get.to(
                            () => SearchPostWithInterestScreen(interest: tag));
                      },
                    );
                  },
                ),
  ...
  Widget usersView(SearchScreenController controller) {
    return RefreshIndicator(
      color: refreshIndicatorColor,
      backgroundColor: refreshIndicatorBgColor,
      onRefresh: () => controller.searchUser(shouldErase: true),
      child: LoadMoreWidget(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return RepaintBoundary(
              child: ProfileCard(user: controller.users[index]),
            );
          },
        ),
      ),
                  ...
                  child: Column(
                    children: [
                      AnimatedContainer(
                        ...
                        height: 2.5,
                        width: controller.selectedPage == index ? 30 : 0,
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: controller.selectedPage == index
                              ? MyTextStyle.gilroySemiBold(
                                  size: 16, color: cNavy)
                              : MyTextStyle.gilroyRegular(
...
class ProfileCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        final companyId =
            user.profileType == 'company' ? user.ownedCompany?.id : null;
