...
class TabBarController extends BaseController {
  ...
  void onInit() {
    ...
    // Mark navigation ready after a short delay to ensure the widget tree is built
    Future.delayed(const Duration(milliseconds: 500), () {
      FirebaseNotificationManager.shared.markNavigationReady();
      CallKitManager.shared.markNavigationReady();
    });
  }
