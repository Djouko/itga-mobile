      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Flexible(
                child: LKeys.doNtHaveAnAccount.toTextTR(MyTextStyle.gilroyLight(color: cLightText, size: 14)),
              ),
              const SizedBox(width: 5),
              GestureDetector(
                onTap: showSignUp,
                child: LKeys.signUp.toTextTR(MyTextStyle.gilroySemiBold(color: cNavy, size: 14)),
              ),
              const Spacer(),
              GestureDetector(
                onTap: showForgot,
                child: LKeys.forgotPassword.toTextTR(MyTextStyle.gilroySemiBold(color: cNavy, size: 14)),
              ),
            ],
          )
        ],
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Flexible(
                child: LKeys.iHaveAnAccount.toTextTR(MyTextStyle.gilroyLight(color: cLightText, size: 14)),
              ),
              const SizedBox(width: 5),
              GestureDetector(
                onTap: showSignIn,
                child: LKeys.signIn.toTextTR(MyTextStyle.gilroySemiBold(color: cNavy, size: 14)),
              ),
              const Spacer(),
              GestureDetector(
                onTap: showForgot,
