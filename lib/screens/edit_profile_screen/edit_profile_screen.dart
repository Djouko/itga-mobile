                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _sectionHeader(LKeys.profileInfo.tr),
                          const SizedBox(height: 8),
                          const CreateRoomHeading(title: LKeys.headline),
                          MyTextField(
                            controller: controller.headlineController,
                            placeHolder: LKeys.headlinePlaceholder.tr,
                          ),
                          const SizedBox(height: 5),
                          const CreateRoomHeading(title: LKeys.pronouns),
                          MyTextField(
                            controller: controller.pronounsController,
                            placeHolder: LKeys.pronounsPlaceholder.tr,
                          ),
                          const SizedBox(height: 5),
                          const CreateRoomHeading(title: LKeys.about),
                          MyTextField(
                            controller: controller.aboutController,
                            placeHolder: LKeys.aboutPlaceholder.tr,
                            isEditor: true,
                            limit: 500,
                          ),
                          const SizedBox(height: 5),
                          const CreateRoomHeading(title: LKeys.skills),
                          MyTextField(
                            controller: controller.skillsController,
                            placeHolder: LKeys.skillsPlaceholder.tr,
                          ),
                          const SizedBox(height: 24),
                          _sectionHeader(LKeys.contactInfo.tr),
                          const SizedBox(height: 8),
                          const CreateRoomHeading(title: LKeys.location),
                          MyTextField(
                            controller: controller.locationController,
                            placeHolder: LKeys.locationPlaceholder.tr,
                          ),
                          const SizedBox(height: 5),
                          const CreateRoomHeading(title: LKeys.website),
                          MyTextField(
                            controller: controller.websiteController,
                            placeHolder: LKeys.websitePlaceholder.tr,
                          ),
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CircleAvatar(
                          backgroundColor: cNavy.withValues(alpha: 0.5),
                          radius: 20,
                          child: Icon(
