              ...
              builder: (controller) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: isDisable ? cLightText.withValues(alpha: 0.3) : cPrimary, borderRadius: BorderRadius.circular(100)),
                    child: Text(
                      LKeys.post.tr.toUpperCase(),
                      style: MyTextStyle.gilroySemiBold(color: isDisable ? cWhite.withValues(alpha: 0.7) : cBlack, size: 14),
                    ),
                  ),
                );
              },
        ...
        child: Container(
          ...
          decoration: ShapeDecoration(
            ...
            shape: const SmoothRectangleBorder(
              borderRadius: SmoothBorderRadius.all(SmoothRadius(cornerRadius: 10, cornerSmoothing: cornerSmoothing)),
