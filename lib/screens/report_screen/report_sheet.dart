          ...
          child: Wrap(
            children: [
              Column(
                ...
                children: [
                  Row(
                    children: [sheetHeading().toTextTR(MyTextStyle.gilroySemiBold(color: cNavy, size: 18)), const Spacer(), const XMarkButton()],
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    child: Divider(height: 1, color: cLightText.withValues(alpha: 0.12)),
                  ),
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                    title(),
                                    style: MyTextStyle.gilroyBold(size: 18, color: cNavy),
                                  ),
                                ],
                              ),
                              subTitle()
